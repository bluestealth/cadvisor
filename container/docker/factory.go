...
func StartThinPoolWatcher(dockerInfo *dockersystemtypes.Info) (*devicemapper.ThinPoolWatcher, error) {
...
func StartZfsWatcher(dockerInfo *dockersystemtypes.Info) (*zfs.ZfsWatcher, error) {
