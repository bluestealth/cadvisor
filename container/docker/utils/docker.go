...
func DockerThinPoolName(info dockersystemtypes.Info) (string, error) {
...
func DockerMetadataDevice(info dockersystemtypes.Info) (string, error) {
...
func DockerZfsFilesystem(info dockersystemtypes.Info) (string, error) {
...
func SummariesToImages(summaries []dockerimagetypes.Summary) ([]v1.DockerImage, error) {
